...
class Projects extends Component {
  ...
  state= {
    ...
    projects: [{projectBackground: `linear-gradient(0.25turn, #186E59, #1F8A70)`,
              ...
              rowHeaders: ['Application Properties', 'Higher Order Components', 'Challenges', 'Solutions'],
              ...
              rowHeaders: ['Application Properties', 'Offline First', 'Solutions'],
            ...
            rowHeaders: ['Application Properties', 'Process', 'Two-Way Data Binding', 'User Considerations'],
            ...
            rowHeaders: ['Application Properties', 'Environment', 'User Considerations'],
            rowSubheaders: ["These are some of the features I helped develop with the Paradeigm Dev team:"],
          ...
          projectPreview: 'https://s3-us-west-1.amazonaws.com/nomnombento/temporaryAidan/book+track+mockup-min.png',
          ...
          imageRows: [],
          rowHeaders: ['Application Properties', 'Challenges', 'User Considerations', 'Value Proposition'],
          rowSubheaders: ["Features of my app include:", "User Centered development considerations were as follows:"],
             ...
             {this.state.projects
               .filter(p => this.state.projects
                 .indexOf(p) === this.state.projectNumber)
                  .map((proj) => {
                    return (
                    <section key={proj.projectHeader} onClick={() => console.log(this.state.projects[this.state.projects.indexOf(proj)])} style={{background: proj.projectBackground, position:'relative', animation: `slideIn${this.state.right ? 'Right' : 'Left'} ease-out .5s`}}>
                      <div id="projNav">
