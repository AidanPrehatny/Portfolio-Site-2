  ...
  state = {
    ...
    projects: [
      ...
      {projectBackground: `linear-gradient(0.25turn, #015584, #09ABAE)`,
        ...
        projectDescription: "The purpose of this project was to update the website for a Pacific Beach, California, Asian cuisine establishment named NomNomBento. The client wanted a quick, responsive and interactive website that maintained company branding with modern web standards. Our team designed and developed a high energy and engaging experience as a result. The website provides a fluid customer experience, providing various different menu item specifications and the ability to build your own dish.",
