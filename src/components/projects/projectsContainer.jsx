  ...
  state= {
    ...
    projects: [
      ...
      {projectBackground: `linear-gradient(0.25turn, #186E59, #1F8A70)`,
        ...
        rowDescriptionsList1: "",
        rowDescriptionsList2: ["Sometimes ill be halfway through development when an issue arises. In this case, my issue was that i needed each name in the side panel window when clicked, to open its corresponding map marker's info window.", "The issue was that i was mapping out the array of venue information twice in my app; one for the map markers and one for the side panel.", "Sometimes it can be useful to map out your component heirarchy to solve these kinds of issues: I needed to communicate info from a sidepane name to a map marker to tell its  infowindow to open."],
