  ...
  state = {
    ...
    projects: [
      ...
      {projectBackground: `linear-gradient(0.65turn, #D1BE92, #FFAF00)`,
        ...
        projectDescription: "The SD Beer App is an interactive app featuring more than 130 of San Diego’s independent breweries and all the ‘Capital of Craft’ has to offer. I worked with a team of developers, playing a role in the application's design direction and developing UI solutions for the mobile user. I programtically composed a variety of  rich functionality to the mobile UI.",
      ...
      {projectBackground: `linear-gradient(0.25turn, #300094, #17BEAC)`,
        ...
        projectDescription: 'GANDER is an up and coming rebranding to the web application Paradeigm Social, designed to improve social content approvals for social media managers. This feature-rich platform provided me with opportunities and tools to learn how to develop scalable web apps. I assisted in the production of many of the platform’s utilities, the features I helped implement provided me with insights into how to better optimize my code and use redux to manage react state on an application-wide scale.',
      ...
      {projectBackground: `linear-gradient(0.25turn, #4F4CB1, #300094)`,
        ...
        projectDescription: 'In this Book tracking mini app, users select and categorize books they have read, are currently reading, or want to read. The project emphasized using React to build the application by configuring a small API to communicate with the backend data to ensure that information persists as the application is interacted with.',
      ...
      {projectBackground: `linear-gradient(0.25turn, #015584, #09ABAE)`,
        ...
        projectDescription: "NomNomBento a Pacific Beach, California, Asian cuisine establishment which has established an online presence to better manage its order processing and delivery services. The client wanted a quick, responsive and interactive website update that maintained company branding with modern web standards. The Paradeigm team and I designed and developed a high energy and engaging experience as a result. The website provides a fluid customer experience, providing various different menu item specifications and the ability to build your own dish.",
